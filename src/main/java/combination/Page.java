...
public class Page {
    ...
    private ArrayList<combination.Page> nextPages; //list of all of the pages.
    ...
    public void addChoice(String choiceText, combination.Page nextPage) {
    ...
    public combination.Page getNextPageForChoice(String userChoice) {
        int choice = -1;
        try {
